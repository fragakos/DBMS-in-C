...
//  BF_Block_Init(&test);
//  int x;
//  BF_GetBlock(openFilesTable[eDentry].fileDesc,getDataBlock(eDentry,NULL),test);
//  while(getNextBlck(test) != 0) {
//    printBlock(test,eDentry);
//    x = getNextBlck(test);
//    CALL_BF(BF_UnpinBlock(test))
//    BF_GetBlock(openFilesTable[eDentry].fileDesc,x,test);
//    if(getNextBlck(test) == 0)
//      printBlock(test,eDentry);
//  }
//  CALL_BF(BF_UnpinBlock(test))
//  BF_Block_Destroy(&test);
//  printf("-----------------------\n-----------------------\n\n");
